function out = MultiPeakPFDistance(gpf, gt, varargin)
% out = MultiPeakPFDistance(gpf, occupancy, varargin)
% 
    defClu = gpf.acceptedUnits;
    defCellPairs = nchoosek(defClu, 2);
    [cellPairs, IF_SMRM, nSTD, areaThreshFactor, occThreshFac, state, binSize, maxTimeLag] = ...
        DefaultArgs(varargin, {defCellPairs, 1, 3, 0.5, 2, 'RUN', 10e-3, 200e-3});
