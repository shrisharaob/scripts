        ...
        % genericTrial = GenericTrial(arg.name);
            ...
            elseif isa(arg, 'MTATrial')
                ...
                switch genericTrial.datasetType
                  ...
                  case 'zhenya'
                    genericTrial.paths.data = ['~/data/zhenya/', fileBase, '/'];
                    genericTrial.paths.analysis = ['~/data/analysis/zhenya/', fileBase, '/'];
                  otherwise
                    ...
                    if ~DirExists('~/data/', fileBase)
                        ...
                        elseif DirExists('~/data/zhenya/', fileBase)
                            genericTrial.datasetType = 'zhenya';
                            genericTrial.paths.data = ['~/data/zhenya/', fileBase, '/'];
                            genericTrial.paths.analysis = ['~/data/analysis/zhenya/', fileBase, '/'];
                            genericTrial.trackingSampleRate = 50;
                            % create a subfolder under analysis folder with  name
                            %  <filebase>, in case it does not exist
                            if ~DirExists('~/data/analysis/zhenya/', fileBase);
                                mkdir([genericTrial.paths.analysis]);
                            end  
