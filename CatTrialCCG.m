...
% since the subfields might be slightly shifted across trials, in di
    ...
    [cellPairs, datasetType, binSize, maxTimeLag, IF_PLOT] = DefaultArgs(varargin, {[], 'kenji', 10e-3, 1000e-3, 1});
    ...
    out.ccg = ccgPars;
    out.dvsoff = dvsoff;
    save(['~/data/analysis/', datasetType, '/', filebase, '/' filebase, '.', mfilename, '.mat']);
end
